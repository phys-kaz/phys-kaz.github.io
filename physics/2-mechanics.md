...
「力」にはいろいろな種類があり、これらの説明は後々の節に回そう。

### 慣性質量

そもそも、なぜ質量ではなく「慣性質量」と呼ぶのだろうか。
それは世の中には「質量」といっても全く別質の量が存在するからである。

いまは「慣性質量」という新しい概念について学ぶのだと思ってもらってもよい。
...
地球上の物体は重力(万有引力の作用) により力を受ける。

しかも、どうやらその力の大きさは、質量に比例し、 $mg$ と表されるらしい。ここでの $m$ はなんであろうか。
ここでの $m$ は重力質量という。

この質量は重力の作用の大小を決めるもので、慣性質量とはその表すものの質が違うことに気づくであろうか。
実はこの「慣性質量」と「重力質量」が等しいというのは、アインシュタインの一般相対性理論によって説明される。

以上で、物体の運動の3法則、位置、速度、加速度が理解できた。
これより下では各種の力やその大きさ、また、エネルギー保存則について、今までの知識を総動員させながらその運動を調べる術を学んでいく。

### 例題 1-2

いま、平面のあるところに固定された的がある。それに向かって球を投げ、投げた瞬間に的を自由落下させると、球は必ず的に当たることを示せ。
